...
// Legal terms are reproduced verbatim and stay in English in both UI languages:
// contract wording is never machine-translated. Replace with counsel-approved
// Arabic text when it exists.
//
